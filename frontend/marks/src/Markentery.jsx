    ...
    <div className="maincontentmarks">
      <div className="editbox"> 
        <Dialog open={opendialog} onClose={closedialog} fullWidth maxWidth="xs">
          <DialogTitle textAlign={"center"} fontSize={25}>Edit Marks</DialogTitle>
          <DialogContent>
            <Stack spacing={1} sx={{ mt: 1 }}>
            <TextField id="outlined-basic" disabled value={vrollno} onChange={(e) => setVrollno(e.target.value)} label="Rollno" variant="outlined" className="textfield" />
            <TextField id="outlined-basic" value={vmark1}  onChange={(e) => setVmark1(e.target.value)} label="Subject 1" variant="outlined" />
            <TextField id="outlined-basic" value={vmark2}   onChange={(e) => setVmark2(e.target.value)} label="Subject 2" variant="outlined" />
            <TextField id="outlined-basic"  value={vmark3} onChange={(e) => setVmark3(e.target.value)} label="Subject 3" variant="outlined" />
            <TextField id="outlined-basic" value={vmark4} onChange={(e) => setVmark4(e.target.value)} label="Subject 4" variant="outlined" />
            <TextField id="outlined-basic" value={vmark5} onChange={(e) => setVmark5(e.target.value)} label="Subject 5" variant="outlined" />
            </Stack>
          </DialogContent>
          <DialogActions>
      ...
      <div className="deletebox">
        ...
        <DialogActions>
            <Button variant="contained" color="primary"  onClick={closedeletedialog}>Close</Button>
      ...
      <div className="inputform">
        <form action="" onSubmit={entermarks}>
          <p>
          <label htmlFor="" className="lable1">
              Rollo no:
            </label>
            <input
              type="number"
          ...
          <tbody>
            {marks.map((marks, rowIndex) => (
              <tr key={rowIndex}>
                ...
                <td><button onClick={()=>opendeletedialog(rowIndex)}>Delete</button></td>
                <td><button onClick={() => edit(rowIndex)}>Edit</button></td>
              </tr>
            ))}
          </tbody>
        </table>
